...
public class Zoo {
  ...
  public static void feed(List<?> list) {
    ...
    for (Object birdValue : list) {
      System.out.println("Feeding bird " + birdValue);
    }
  }
  ...
  public static void acceptBird(List<? super FlyingBird> list, FlyingBird bird) {
    ...
    bird.checkWings();
      ...
      list.add(bird);
      System.out.println("Adding new bird " + bird + " to the list.");

    for (Object birdValue : list) {
      System.out.println("Bird in the list is: " + birdValue);
    }
  }
  ...
  public static void registerBird(List<? super Bird> list, Bird newBird) {
    ...
    list.add(newBird);
    System.out.println("Adding new bird " + newBird + " to the list.");
